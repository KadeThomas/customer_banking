...
def main():
    ...
    print(f'Interest earned on the savings account is: ${interest_earned:.2f}')
    print(f'The new balance of the savings account is: ${updated_savings_balance:.2f}')
    ...
    print(f'Interest earned on the CD account is: ${interest_earned:.2f}')
